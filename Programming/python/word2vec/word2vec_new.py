...
from word2vec.training_data_generator import WikipediaPageProcessor
from word2vec.training_data_iterator import LineIterator
...
if __name__ == '__main__':
    if os.path.exists(data_set_name):
        ...
        model.intersect_word2vec_format(fname="../../../data/Model/GoogleNews-vectors-negative300.bin.gz", binary=True)

        lines = LineIterator(dirname="../../../data/training/processed")
        model.train(lines)
